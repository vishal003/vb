...
export const DEFAULT_DATA = {
  personal: {
    ...
    lastName: "Badgujar",
    title: "Assistant Professor (PhD Computer Engineering)",
  ...
  publications: {
    journals: [
      { id: "pub_j1", title: "EGNCND: Design of an Efficient Graph Network Model for Enhancing Cybersecurity in Network Deployments", authors: "Badgujar, V.S., Raut, C.M., Pande, A.", journal: "Journal of Information Security and Applications (JISA), Elsevier", indexed: "(Accepted and in press) (SCIE, Scopus Indexed)" },
      { id: "pub_j2", title: "Design of an Iterative Method for Enhanced Network Security Risk Assessment Incorporating Hierarchical Attention, Multi-Dimensional Centrality, and Adaptive Resilience Simulation", authors: "Badgujar, V.S., Raut, C.M., Pande, A.", journal: "Journal of Information Security and Applications (JISA), Elsevier", indexed: "(Accepted and in press) (SCIE, Scopus Indexed)" },
      { id: "pub_j3", title: "MAOMLB: Advancing Malware Analysis with AI-Based Open-Source Architecture Integrating Machine Learning and Behavioral Techniques", authors: "Badgujar, V.S., Raut, C.M., Pande, A.", journal: "Journal of Applied Research and Technology (JART)", indexed: "Scopus Indexed" },
      { id: "pub_j4", title: "RNN Based Rapid Threat Detection And Response System", authors: "Badgujar, V., Raut, C.", journal: "Industrial Engineering Journal", year: "2023", indexed: "UGC CARE Group-1" },
      { id: "pub_j5", title: "Secrets Of Mindmap In A Education", authors: "Badgujar, V., Raut, C.", journal: "Industrial Engineering Journal", year: "2023", indexed: "UGC CARE Group-1" },
      { id: "pub_j6", title: "Effect of Blackhole Intrusion in Wireless Networks", authors: "Badgujar, V., Dhage, S.", journal: "International Journal of Computer Engineering, and Application (IJCEA)", year: "2017" }
    ],
    conferences: [
      { id: "pub_c1", title: "VSecureSphere: Developing Virtual Lab for Simulating Safe Environment for Multiple Cyber-Attack Patterns", authors: "Zagade, S., Shardul, M., Patole, S., Badgujar, V., et al.", conference: "Springer LNEE", year: "2026", link: "https://doi.org/10.1007/978-981-96-9724-3_16" },
      { id: "pub_c2", title: "ProjectSpace: A Comprehensive Framework for Automated Project Guide Allocation in Academic Institutions", authors: "Bhavsar, P.H., Badgujar, V.S, et al.", conference: "Springer LNNS", year: "2026", link: "https://doi.org/10.1007/978-981-96-8107-5_24" },
      { id: "pub_c3", title: "Deep Learning-Based Hierarchical Attention Mechanism for Risk Prediction", authors: "Badgujar, V.S., Raut, C.M.", conference: "Springer LNNS", year: "2025", indexed: "Scopus Indexed", link: "https://doi.org/10.1007/978-981-96-4142-0_37" },
      { id: "pub_c4", title: "BAOSAML: Behavioral AI-Based Open-Source Architecture for Malware Analysis Using Machine Learning", authors: "Badgujar, V.S., Raut, C.M.", conference: "Springer LNNS", year: "2025", indexed: "Scopus Indexed", link: "https://doi.org/10.1007/978-981-96-2703-5_37" },
      { id: "pub_c5", title: "ChatApsit: A Generative AI-Based Comprehensive Web Framework for an Educational Institute", authors: "Madhur Dukhande, Mayur Jain, Aryan Amin, Kaushal Nikam, Vishal Badgujar, Kiran Deshpande", conference: "Springer LNNS", year: "2024", link: "https://link.springer.com/chapter/10.1007/978-981-97-4149-6_16" },
      { id: "pub_c6", title: "Varishta Rakshak: An AI-Based Comprehensive Web Framework for Ensuring Senior Citizen Care in Real Time", authors: "Meet Bohra, Yashab Mahimi, Rupesh Mishra, Vishal Badgujar, Kiran Deshpande, Shradha Birje", conference: "Springer LNNS", year: "2024", link: "https://link.springer.com/chapter/10.1007/978-981-97-4149-6_14" },
      { id: "pub_c7", title: "AI-ML Based Smart Online Examination Framework", authors: "Sapre, S., Shinde, K., Shetta, K., Badgujar, V.", conference: "Springer LNNS", year: "2022", indexed: "Scopus Indexed", link: "https://link.springer.com/chapter/10.1007/978-3-030-98531-8_2" },
      { id: "pub_c8", title: "Automation of Supply Chain Management for Healthcare", authors: "Saiya, H., Doshi, S., Seth, J., Badgujar, V., Kalme, G.", conference: "Springer LNNS", year: "2022", indexed: "Scopus Indexed", link: "https://link.springer.com/chapter/10.1007/978-3-030-98531-8_4" },
      { id: "pub_c9", title: "Spaced Repetition Based Adaptive E-Learning Framework", authors: "Kharwal, A., Umrotkar, N., Godambe, V., Kolekar, U., Badgujar, V.", conference: "Springer LNNS", year: "2022", indexed: "Scopus Indexed", link: "https://link.springer.com/chapter/10.1007/978-3-030-98531-8_3" },
      { id: "pub_c10", title: "Smart UAV Framework for Multi-Assistance", authors: "Patil, V., Potphode, V., Potdukhe, U., Badgujar, V., Upadhyaya, K", conference: "Springer SIST", year: "2021", indexed: "Scopus Indexed", link: "https://link.springer.com/chapter/10.1007/978-981-16-4177-0_26" },
      { id: "pub_c11", title: "On Trade Cloud Ecosystem Structure for Shared Learning", authors: "Narawade, V.E., Badgujar, V.S.", conference: "Springer LNNS", year: "2022", indexed: "Scopus Indexed", link: "https://link.springer.com/chapter/10.1007/978-981-16-5987-4_54" },
      { id: "pub_c12", title: "A REVIEW ON SECURITY OF IOT AD-HOC NETWORK IN 5G", authors: "Nilkanth Talwadekar, Vishal Badgujar, Uttam D. Kolekar", conference: "BookRivers", year: "2023", link: "https://books.google.co.in/books?hl=en&lr=&id=5HLKEAAAQBAJ&oi=fnd&pg=PA65" },
      { id: "pub_c13", title: "Artificial Intelligence based Security Orchestration, Automation and Response System", authors: "R. Vast, S. Sawant, A. Thorbole, V. Badgujar", conference: "IEEE I2CT", year: "2021", link: "https://ieeexplore.ieee.org/document/9418109" },
      { id: "pub_c14", title: "Autonetics and Administration for IT Laboratories", authors: "V. Karthikeyan, U. Maity, A. Shetty, S. Nanivadekar, V. Badgujar", conference: "IEEE ICCDW", year: "2020", link: "https://ieeexplore.ieee.org/document/9318644" },
      { id: "pub_c15", title: "Artificial Intelligence based Self-Driving Car", authors: "H. Thadeshwar, V. Shah, M. Jain, R. Chaudhari, V. Badgujar", conference: "IEEE ICCCSP", year: "2020", link: "https://ieeexplore.ieee.org/document/9315223" },
      { id: "pub_c16", title: "Study on feasibility of Uniform Appraisal System", authors: "U. Naik, D. Choudhury, A. Devade, A. Aher, V. Badgujar", conference: "IEEE ic-ETITE", year: "2020", link: "https://ieeexplore.ieee.org/document/9077847" },
      { id: "pub_c17", title: "Study on Semi Automation in Uniform Faculty Appraisal System", authors: "U. Naik, D. Choudhury, A. Devade, A. Aher, V. Badgujar", conference: "IEEE ICACCS", year: "2020", link: "https://ieeexplore.ieee.org/document/9074383" },
      { id: "pub_c18", title: "ML Enabled Surveillance System for Societies", authors: "P. Chauhan, S. Gupta, R. Arava, S. Nanivadekar, V. Badgujar", conference: "IEEE ic-ETITE", year: "2020", link: "https://ieeexplore.ieee.org/document/9077746" },
      { id: "pub_c19", title: "Case Study on an Android App for Inventory Management System with Sales Prediction for Local Shopkeepers in India", authors: "T. Tandel, S. Wagal, N. Singh, R. Chaudhari, V. Badgujar", conference: "IEEE ICACCS", year: "2020", link: "https://ieeexplore.ieee.org/abstract/document/9074234" },
      { id: "pub_c20", title: "IoT-Key Towards Automation", authors: "A. A. Karia, L. V. Budhwani, V. S. Badgujar", conference: "IEEE ICSCET", year: "2018", link: "https://ieeexplore.ieee.org/document/8537261" },
      { id: "pub_c21", title: "All About Cloud: A Systematic Survey", authors: "A. G. Prajapati, S. J. Sharma, V. S. Badgujar", conference: "IEEE ICSCET", year: "2018", link: "https://ieeexplore.ieee.org/document/8537277" },
      { id: "pub_c22", title: "A Comprehensive Survey on Theoretic Perspective Providing Future Directions on IoT", authors: "A. A. Patil, V. S. Badgujar", conference: "IEEE ICSCET", year: "2018", link: "https://ieeexplore.ieee.org/document/8537285" }
    ],
    sci: []
  },

  books: [
    { id: "book1", title: "Cyber Forensics", authors: "Vishal Badgujar", publisher: "University of Mumbai IDOL Publication", year: "2022" },
    { id: "book2", title: "Intrusion Detection System in Wireless Sensor Network: Comparison of Different IDS Schemes", authors: "Vishal Badgujar, Sudhir Dhage", publisher: "LAP LAMBERT Academic Publishing", year: "2017", link: "https://www.amazon.com/Intrusion-Detection-System-Wireless-Network/dp/6202015063" }
  ],
  ...
  professionalActivities: {
    ...
    conferenceAssociations: [
      { id: "ca1", organization: "Springer LNNS", role: "Author / Contributor" },
      { id: "ca2", organization: "Springer LNEE", role: "Author / Contributor" },
      { id: "ca3", organization: "Springer SIST", role: "Author / Contributor" },
      { id: "ca4", organization: "BookRivers", role: "Author / Contributor" },
      { id: "ca5", organization: "IEEE I2CT", role: "Author / Contributor" },
      { id: "ca6", organization: "IEEE ICCDW", role: "Author / Contributor" },
      { id: "ca7", organization: "IEEE ICCCSP", role: "Author / Contributor" },
      { id: "ca8", organization: "IEEE ic-ETITE", role: "Author / Contributor" },
      { id: "ca9", organization: "IEEE ICACCS", role: "Author / Contributor" },
      { id: "ca10", organization: "IEEE ICSCET", role: "Author / Contributor" }
    ],
    journalAssociations: [
      { id: "rev1", journal: "Elsevier Computers & Security" },
      { id: "rev2", journal: "Elsevier Computer Networks" },
  ...
  gallery: [
    ...
    { id: "gal5", src: "/images/gallery/img9.png", caption: "PhD Degree Award Ceremony", category: "Academic" },
