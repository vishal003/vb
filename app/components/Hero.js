...
export default function Hero() {
  ...
  return (
    <section className="hero" id="home" style={{ padding: '120px 0 60px 0', background: 'var(--bg-primary)', overflow: 'hidden', minHeight: '100vh', display: 'flex', alignItems: 'center' }}>
      ...
      <div style={{ width: '100%', maxWidth: '1300px', margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0 5%', gap: '40px' }}>
        ...
        {/* RIGHT — Image with effects (Xander-inspired) */}
        <div style={{ position: 'relative', width: '440px', height: '500px', flexShrink: 0 }}>
          ...
          <div style={{
            ...
            zIndex: 0, animation: 'pulse-ring 4s ease-in-out infinite'
          }} />
          <div style={{
            position: 'absolute', top: '50%', left: '50%',
            transform: 'translate(-50%, -50%)',
            ...
            zIndex: 0, animation: 'pulse-ring 4s ease-in-out infinite 1s'
          }} />
          ...
          <div style={{
            ...
            zIndex: 0, animation: 'orbit 30s linear infinite'
          }} />
          ...
          <img
            ...
            style={{
              ...
              width: '350px', height: 'auto', zIndex: 1,
              borderRadius: '12px',
              objectFit: 'cover'
            }}
          ...
          <div style={{ position: 'absolute', bottom: '15%', left: '-5%', background: 'var(--bg-card)', padding: '14px 20px', borderRadius: '12px', boxShadow: 'var(--shadow-lg)', display: 'flex', alignItems: 'center', gap: '10px', zIndex: 2, backdropFilter: 'blur(10px)' }}>
          ...
          {/* Certified badge */}
          <div style={{ position: 'absolute', top: '30%', right: '-5%', background: 'var(--bg-card)', padding: '14px', borderRadius: '12px', boxShadow: 'var(--shadow-lg)', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '6px', zIndex: 2, textAlign: 'center', backdropFilter: 'blur(10px)' }}>
